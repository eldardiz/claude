...
To install a skill into a project, say "install skill [name]".
Claude will fetch the SKILL.md from the URL below and append it to the local project CLAUDE.md.
